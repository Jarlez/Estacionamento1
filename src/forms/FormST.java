 ...
 */
public class FormST extends javax.swing.JFrame {

    /**
     * Creates new form FormST
     */
    public FormST() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        barraSistema = new javax.swing.JMenuBar();
        ...
        mnContaCorrente.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, 0));
        ...
        mnConta.add(mnContaCorrente);

        mnAbrir.add(mnConta);

        barraSistema.add(mnAbrir);

        mnSistema.setText("Sistema");
        barraSistema.add(mnSistema);

        setJMenuBar(barraSistema);
    ...
    private void mnContaCorrenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnContaCorrenteActionPerformed
        FormContaCorrente fcc = new FormContaCorrente();
        fcc.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormST.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormST().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JMenuBar barraSistema;
